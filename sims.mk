...
BINDIR ?= $(GOPATH)/bin
SIMAPP = github.com/fetchai/fetchd/app
...
test-sim-custom-genesis-fast:
	...
	@echo "By default, ${HOME}/.fetchd/config/genesis.json will be used."
	@go test -mod=readonly $(SIMAPP) -run TestFullGaiaSimulation -Genesis=${HOME}/.fetchd/config/genesis.json \
...
test-sim-custom-genesis-multi-seed: runsim
	...
	@echo "By default, ${HOME}/.fetchd/config/genesis.json will be used."
	@$(BINDIR)/runsim -Jobs=4 -Genesis=${HOME}/.fetchd/config/genesis.json 400 5 TestFullGaiaSimulation
