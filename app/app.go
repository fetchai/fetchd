...
func New(
	...
	skipUpgradeHeights map[int64]bool, homePath string, invCheckPeriod uint, encodingConfig appparams.EncodingConfig,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		appCodec, keys[authtypes.StoreKey], app.GetSubspace(authtypes.ModuleName), authtypes.ProtoBaseAccount, maccPerms, "fetch",
	)
	...
	*/
	...
	app.mm = module.NewManager(
		...
		mint.NewAppModule(appCodec, app.MintKeeper, app.AccountKeeper, nil), // TODO set custom inflation func here
	...
	cfg := module.NewConfigurator(app.appCodec, app.msgSvcRouter, app.GRPCQueryRouter())
