...
func TestGaiaCLIKeysAddRecover(t *testing.T) {
	...
	require.Equal(t, "fetch1qcfdf69js922qrdr4yaww3ax7gjml6pd7du7tz", f.KeyAddress("test-recover").String())
...
func TestGaiaCLIKeysAddRecoverHDPath(t *testing.T) {
	...
	require.Equal(t, "fetch1qcfdf69js922qrdr4yaww3ax7gjml6pd7du7tz", f.KeyAddress("test-recoverHD1").String())
	...
	require.Equal(t, "fetch1pdfav2cjhry9k79nu6r8kgknnjtq6a7rhtjetn", f.KeyAddress("test-recoverH2").String())
	...
	require.Equal(t, "fetch1909k354n6wl8ujzu6kmh49w4d02ax7qvvt93jy", f.KeyAddress("test-recoverH3").String())
	...
	require.Equal(t, "fetch1v9plmhvyhgxk3th9ydacm7j4z357s3nhcneklu", f.KeyAddress("test-recoverH4").String())
...
func TestGaiaCLIMinimumFees(t *testing.T) {
	...
	// start fetchd server with minimum fees
...
func TestGaiaCLICreateValidator(t *testing.T) {
	...
	consPubKey := sdk.MustBech32ifyPubKey(sdk.Bech32PubKeyTypeConsPub, bls12_381.GenPrivKey().PubKey())
