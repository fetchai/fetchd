...
func newTableBuilder(prefixData byte, storeKey sdk.StoreKey, model codec.ProtoMarshaler, cdc codec.Marshaler) (*tableBuilder, error) {
	if model == nil {
		return nil, errors.Wrap(ErrArgument, "Model must not be nil")
	}
	if storeKey == nil {
		return nil, errors.Wrap(ErrArgument, "StoreKey must not be nil")
	}
...
func TestTableBuilder(prefixData byte, storeKey sdk.StoreKey, model codec.ProtoMarshaler, cdc codec.Marshaler) (*tableBuilder, error) {
