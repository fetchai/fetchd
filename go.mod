...
replace github.com/cosmos/cosmos-sdk => github.com/fetchai/cosmos-sdk v0.10.0

replace github.com/tendermint/tendermint => github.com/n-hutton/cosmos-consensus v0.5.2-0.20201001122429-3ee30efb5cee
