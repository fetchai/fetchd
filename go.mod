...
replace (
	...
	github.com/strangelove-ventures/tokenfactory => github.com/fetchai/tokenfactory v0.1.0-rc3
...
replace github.com/cosmos/cosmos-sdk => github.com/fetchai/cosmos-sdk v0.20.0-rc2
