...
func TestGasCostOnQuery(t *testing.T) {
	const (
		...
		GasWork50 uint64 = InstanceCost + 8_462 // this is a little shy of 50k gas - to keep an eye on the limit

		GasReturnUnhashed uint64 = 636
...
func TestLimitRecursiveQueryGas(t *testing.T) {
	...
	const (
		// Note: about 100 SDK gas (10k wasmer gas) for each round of sha256
		GasWork2k uint64 = InstanceCost + 233_377 // we have 6x gas used in cpu than in the instance
