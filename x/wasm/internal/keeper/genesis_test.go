	...
	genesis := `
{
  ...
  "codes": [
    {
      ...
      "code_info": {
        "code_hash": %q,
        "creator": "fetch1w25zsayvx3rwk0840vdpacev6rt83y7gyseyce",
        "source": "https://example.com",
        "builder": "foo/bar:tag",
        "instantiate_config": {
          "permission": "OnlyAddress",
          "address": "fetch1w25zsayvx3rwk0840vdpacev6rt83y7gyseyce"
        }
      },
      "code_bytes": %q
    }
  ...
  "contracts": [
    {
      "contract_address": "fetch1ckvh6fp75eenpkpnj88e2fv4hsdqnhc9lmd60r",
      "contract_info": {
        "code_id": "1",
        "creator": "fetch13k6l84d7ceu744p660zy3zgtsz93v976zfuqml",
        "admin": "fetch13k6l84d7ceu744p660zy3zgtsz93v976zfuqml",
        "label": "ȀĴnZV芢毤"
      }
    }
  ],
  ...
  {"id_key": %q, "value": "2"}
	...
	codeCreatorAddr, _ := sdk.AccAddressFromBech32("fetch1w25zsayvx3rwk0840vdpacev6rt83y7gyseyce")
	...
	// verify contract
	contractAddr, _ := sdk.AccAddressFromBech32("fetch1ckvh6fp75eenpkpnj88e2fv4hsdqnhc9lmd60r")
	gotContractInfo := keeper.GetContractInfo(ctx, contractAddr)
	require.NotNil(t, gotContractInfo)
	contractCreatorAddr, _ := sdk.AccAddressFromBech32("fetch13k6l84d7ceu744p660zy3zgtsz93v976zfuqml")
	adminAddr, _ := sdk.AccAddressFromBech32("fetch13k6l84d7ceu744p660zy3zgtsz93v976zfuqml")
