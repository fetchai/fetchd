...
func TestProposalStrings(t *testing.T) {
  ...
  Title:       Foo
  Description: Bar
  Run as:      fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t
...
`,
  ...
  Description: Bar
  Run as:      fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t
  Admin:       fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t
  Code id:     1
  Label:       testing
  InitMsg:     "{\"verifier\":\"fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t\",\"beneficiary\":\"fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t\"}"
  InitFunds:   1foo,2bar
`,
		},
...
`,
  ...
  Title:       Foo
  Description: Bar
  Contract:    fetch13k6l84d7ceu744p660zy3zgtsz93v976zfuqml
  Code id:     1
  Run as:      fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t
  MigrateMsg   "{\"verifier\":\"fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t\"}"
`,
		},
		"update admin": {
			src: UpdateAdminProposalFixture(),
  ...
  Description: Bar
  Contract:    fetch13k6l84d7ceu744p660zy3zgtsz93v976zfuqml
  New Admin:   fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t
`,
		},
		"clear admin": {
			src: ClearAdminProposalFixture(),
...
func TestProposalYaml(t *testing.T) {
	specs := map[string]struct {
		...
		"store code": {
			...
			exp: `title: Foo
description: Bar
run_as: fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t
...
code_id: 1
label: testing
init_msg: '{"verifier":"fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t","beneficiary":"fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t"}'
init_funds:
- denom: foo
  amount: "1"
- denom: bar
...
contract: fetch13k6l84d7ceu744p660zy3zgtsz93v976zfuqml
code_id: 1
msg: '{"verifier":"fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t"}'
run_as: fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t
`,
		},
		"update admin": {
			...
			exp: `title: Foo
description: Bar
new_admin: fetch1qyqszqgpqyqszqgpqyqszqgpqyqszqgppwg60t
contract: fetch13k6l84d7ceu744p660zy3zgtsz93v976zfuqml
`,
		},
		"clear admin": {
